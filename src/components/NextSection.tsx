  ...
  return (
    <section className="next-section">
      <div className="">
            ...
            <img src="/src/Assets/thirdcomp/Background.png" alt="App mock" className="card-img" />
      </div>

      <div className="management-section flex">
        <img src="/src/Assets/thirdcomp/SVG.png" alt="decor" className="" />
        ...
        <img src="/src/Assets/thirdcomp/Container.png" alt="decor" className="" />
